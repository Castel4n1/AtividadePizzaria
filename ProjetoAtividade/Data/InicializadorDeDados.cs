        ...
        public static void Inicializar(IApplicationBuilder builder)
        {
            using (var serviceScope = builder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Pizzas.Any())
                {
                    ...
                    {
                        new Pizza(1,"Pizza de Peperoni","https://static8.depositphotos.com/1328914/862/i/600/depositphotos_8629462-stock-photo-pepperoni-pizza.jpg",100,1),
                        new Pizza(2,"Pizza de Mussarela","https://media.gettyimages.com/photos/cooking-italian-vegetarian-pizza-with-vegetables-and-mushrooms-at-on-picture-id1253249913?s=2048x2048",300,1),
                        new Pizza(3,"Pizza de Atum","https://media.gettyimages.com/photos/pizza-tuna-onion-herbs-on-plate-picture-id182878095?s=2048x2048",500,1)
                    });
                    context.SaveChanges();
                }
